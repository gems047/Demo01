...
def query():
        ...
        #img_data = '/home/user/Monsoon_Courses_2020/Research/Presentation_Results/deploy_heroku/img_upload/'+filename
        file_path = app.config["IMAGE_UPLOADS"]+'/' + filename
    
        #convert image data into feature
